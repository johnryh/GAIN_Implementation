...
import resnet_v1_50.resnet_utils as resnet_utils
...
def resnet_v1_50(inputs,
  ...
  blocks = [resnet_v1_block('block1', base_depth=depth_func(64), num_units=3,stride=2),
  ...
  return resnet_v1(inputs, blocks, num_classes, is_training, global_pool=global_pool, output_stride=output_stride,
                   include_root_block=True, spatial_squeeze=spatial_squeeze,store_non_strided_activations=store_non_strided_activations,
